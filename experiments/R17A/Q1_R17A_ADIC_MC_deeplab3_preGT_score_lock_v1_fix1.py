...
VERSION = "2026-09-09-Q1-R17A-ADIC-MC-DEEPLAB3-PREGT-SCORE-LOCK-v1-fix1"
DEFAULT_ROOT = Path(r"F:\MEDSEG_SAFETTA")
OUT_REL = Path(r"outputs\Q1_R17A_ADIC_MC_deeplab3_preGT_score_lock_v1_fix1")
...
def compile_exact_input_prefix(r05):
    ...
    provided_names = {"r03", "target", "i", "device"}
