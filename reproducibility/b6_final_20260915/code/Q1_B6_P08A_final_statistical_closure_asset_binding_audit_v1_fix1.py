...
VERSION = "2026-09-15-B6-P08A-v1-fix1"
...
OUT_DIR = ROOT / "B6_P08A_final_statistical_closure_asset_binding_audit_v1_fix1"
...
def main():
    ...
    status = (
        "PASS"
        if loao["route"] != "STOP_NEOPOLYP_LOAO_ROW_LEVEL_BINDING_INCOMPLETE"
    ...
    decision = {
        ...
        "next": (
            "Generate a P08 LOAO binding amendment, then P08B paired bootstrap + event-support/statistical-unit closure."
            if status == "PASS"
