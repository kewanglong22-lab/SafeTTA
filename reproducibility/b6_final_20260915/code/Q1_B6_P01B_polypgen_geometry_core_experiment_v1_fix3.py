...
Fix3 binds the exact R33A3 4596-row unseen-MEMO outcome panel, the R33A2B pre-HARM Q66 feature lock, and the R33A2B pre-HARM frozen full score; Fix2 source-side consensus collapse is retained.\n\nThis is the first scientific P01B experiment after:
...
VERSION = "2026-09-15-B6-P01B-GEOM-CORE-v1-fix3"
...
OUT_DIR = ROOT / "B6_P01B_polypgen_geometry_core_experiment_v1_fix3"
