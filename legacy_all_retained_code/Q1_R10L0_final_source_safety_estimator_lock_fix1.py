...
"""
Q1_R10L0_final_source_safety_estimator_lock_fix1.py
...
DEFAULT_OUTPUT = (
    "F:/MEDSEG_SAFETTA/outputs/"
    "Q1_R10L0_final_source_safety_estimator_lock_fix1_v1"
)
...
def main():
    ...
    print("===== R10L0 FINAL SOURCE SAFETY ESTIMATOR LOCK FIX1 =====")
    ...
    if not np.allclose(
        ...
        raise AssertionError("Serialized estimator round-trip mismatch.")
