...
VERSION = "2026-08-19-Q1-S01-v1-fix2"
BUILD = "Q1_S01_PRE_ADAPTATION_SUSCEPTIBILITY_MECHANISM_AUDIT_ROW_ORDER_FIX2"
...
def validate_and_merge(inputs):
    ...
    # IMPORTANT (fix2):
    # Preserve the exact frozen Q1-S00A feature-table row order.
    # Q1-S00A trained its grouped-OOF models on this order. Re-sorting the
    # same rows can change floating-point optimization trajectories in
    # liblinear enough to violate the preregistered 1e-6 reproduction check.
    # This changes NO samples, features, labels, folds, or criteria.
    return merged, {
        "rows": len(merged),
...
def run(args):
    ...
    print("ROW_ORDER_FIX: PRESERVE_FROZEN_Q1_S00A_FEATURE_TABLE_ORDER")
