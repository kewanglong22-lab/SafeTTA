...
"""
Q1_R10L3A_polypgen_source_a1_prediction_lock_fix1.py
...
VERSION = "2026-08-26-Q1-R10L3A-v1-fix1"
BUILD = "Q1_R10L3A_POLYPGEN_SOURCE_A1_PREDICTION_LOCK_FIX1"
...
OUTPUT_DIR = (
    ROOT / "outputs"
    / "Q1_R10L3A_polypgen_source_a1_prediction_lock_fix1_v1"
)
...
def run(args):
    ...
    if build_dir.exists() and not args.resume:
        raise FileExistsError(
            f"Partial R10L3A output exists: {build_dir}. "
    ...
    for state in panel:
        ...
        npz_path, index_path, sidecar_path, rows = run_state(
            r05d3=r05d3,
            r03=r03,
            state=state,
            targets=targets,
    ...
    run_lines = [
        "===== R10L3A POLYPGEN SOURCE + A1 PREDICTION LOCK FIX1 =====",
