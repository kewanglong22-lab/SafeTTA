...
r"""
S01-B: PraNet source-only pilot training, frozen seed 20260817.
...
VERSION = "2026-08-17-S01-B-v1-fix1"
BUILD = "S01_B_FIX1_SELFTEST_COUNT_PARITY"
...
DEFAULT_OUTPUT = ROOT / "outputs" / "S01_B_pranet_source_only_seed20260817_v1"
...
def train(args):
    ...
    try:
        ...
        audit = {
            ...
            "decision": "S01_B_SEED20260817_SOURCE_MODEL_READY_FOR_SANITY_REVIEW",
        }
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train S01-B PraNet source-only seed 20260817."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
