...
VERSION = "2026-08-18-S06-B-v1"
BUILD = "S06_B_ZIP_INPLACE_IMAGE_OVERLAP_AUDIT_NO_MASK_BYTES"
...
PROTOCOL = (
    ROOT / "docs"
    / "S06_A_polypgen_untouched_external_confirmation_protocol_v1.md"
)
EXPECTED_PROTOCOL_SHA256 = "80811e496156cfa7e0a21f24660ab1308a8bb6df631428954de908576da599b2"
...
OUTPUT_DIR = (
    ROOT / "outputs" / "S06_B_polypgen_integrity_overlap_audit_v1"
)
...
def is_single_frame_branch(name: str):
    p = re.sub(
        r"[^a-z0-9]+",
        "_",
...
def classify_single_frame_member(name: str):
    ...
    if suffix_of(n) not in IMAGE_SUFFIXES:
        return None, None
    if not is_single_frame_branch(n):
        return None, None
