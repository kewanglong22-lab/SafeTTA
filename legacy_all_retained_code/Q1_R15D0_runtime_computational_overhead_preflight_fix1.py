...
VERSION = "2026-09-04-Q1-R15D0-v1-fix1"
BUILD = "Q1_R15D0_RUNTIME_COMPUTATIONAL_OVERHEAD_PREFLIGHT_FIX1"
...
DEFAULT_OUTPUT = (
    OUT
    / "Q1_R15D0_runtime_computational_overhead_preflight_fix1_v1"
)
...
def audit_transformers_cache():
    ...
    try:
        ...
        # Preflight only: instantiate from LOCAL cache, no network.
        ...
        print("local_files_only load: PASS")
        print("model class:", result["model_class"])
        ...
        result["error"] = repr(e)
        print("local_files_only load: FAIL")
        print("error:", repr(e))
...
def main():
    ...
    if not dino["local_files_only_load"]:
        raise RuntimeError(
            "facebook/dinov2-base is not available from local cache. "
