...
"""
Q1_R10K0_spatial_mask_subspace_LOMO_feasibility_fix2.py
...
DEFAULT_OUTPUT = (
    "F:/MEDSEG_SAFETTA/outputs/"
    "Q1_R10K0_spatial_mask_subspace_LOMO_feasibility_fix2_v1"
)
...
def main():
    ...
    print("===== R10K0 SPATIAL MASK SUBSPACE LOMO FEASIBILITY FIX2 =====")
