...
VERSION = "2026-09-05-Q1X-CM7A-v1-fix1"
BUILD = "Q1X_CM7A_PROMISE12_EXTERNAL_RANKING_BASELINE_AUDIT_FIX1"
...
DEFAULT_OUTPUT = (
    OUT
    / "Q1X_CM7A_promise12_external_ranking_baseline_audit_fix1_v1"
)
...
def main():
    ...
    print(
        "===== Q1X CM7A PROMISE12 POST-GT EXTERNAL RANKING BASELINE AUDIT ====="
    )
