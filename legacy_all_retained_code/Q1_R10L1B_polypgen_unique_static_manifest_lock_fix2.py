...
"""
Q1_R10L1B_polypgen_unique_static_manifest_lock_fix2.py
...
DEFAULT_OUTPUT = (
    "F:/MEDSEG_SAFETTA/outputs/"
    "Q1_R10L1B_polypgen_unique_static_manifest_lock_fix2_v1"
)
...
def main():
    ...
    print("===== R10L1B POLYPGEN UNIQUE STATIC MANIFEST LOCK FIX2 =====")
