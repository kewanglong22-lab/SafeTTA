...
VERSION = "2026-08-18-S05-D-v1-fix1"
BUILD = "S05_D_FIX1_CORRECT_S05C_S05B_HELPER_COMPOSITION"
...
PROTOCOL = ROOT / "docs" / "S05_D_deeplab_locked_target_replication_protocol_v1_fix1.md"
EXPECTED_PROTOCOL_SHA256 = "3385ae4c6fa6f18df7954ca45daca6e365824a80dc7de97776404f3552779be6"
...
OUTPUT_DIR = (
    ROOT / "outputs"
    / "S05_D_deeplab_locked_safettta_target_replication_v1_fix1"
)
...
def build_global_no_label_lock(
    ...
    global_lock = {
        ...
        "s05b_training_helper_sha256": helper.EXPECTED_TRAINING_HELPER_SHA256,
