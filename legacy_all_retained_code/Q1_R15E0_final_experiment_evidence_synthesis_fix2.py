...
VERSION = "2026-09-04-Q1-R15E0-v1-fix2"
BUILD = "Q1_R15E0_FINAL_EXPERIMENT_EVIDENCE_SYNTHESIS_FIX2"
...
DEFAULT_OUTPUT = (
    OUT
    / "Q1_R15E0_final_experiment_evidence_synthesis_fix2_v1"
)
...
def dataframe_to_markdown_no_tabulate(df: pd.DataFrame) -> str:
    """
    Minimal Markdown-table renderer with no optional dependency on `tabulate`.

    This is intentionally read-only formatting logic only.
    """
    def esc(v):
        if pd.isna(v):
            return ""
...
def main():
    ...
    print("FIX2_CHANGE=REMOVE_OPTIONAL_TABULATE_DEPENDENCY_ONLY")
    print("SCIENTIFIC_CONTENT_CHANGE_FROM_FIX1=NO")
    ...
    md.append("")
    md.append(dataframe_to_markdown_no_tabulate(a_point))
    md.append("")
    md.append(
    ...
    md.append("")
    md.append(dataframe_to_markdown_no_tabulate(b_table))
    md.append("")
    md.append(
    ...
    md.append("")
    md.append(dataframe_to_markdown_no_tabulate(c_table))
    md.append("")
    md.append(
    ...
    md.append("")
    md.append(dataframe_to_markdown_no_tabulate(d_table))
    md.append("")
    md.append(
