...
- bootstrap RNG = numpy.random.default_rng (exact historical R10K2C);
...
Fix2 restores the exact historical NumPy Generator RNG. The historical
PRIMARY-vs-M2 bootstrap rows are reproduced exactly against
...
VERSION = "2026-09-04-Q1-R15A1-v1-fix2"
BUILD = "Q1_R15A1_CORE_ABLATION_CASE_CLUSTERED_PAIRED_BOOTSTRAP_FIX2"
...
def main():
    ...
    print("BOOTSTRAP_RNG=np.random.default_rng")
    print("FIX2_CHANGE=RESTORE_EXACT_HISTORICAL_R10K2C_RNG_ONLY")
