...
VERSION = "2026-09-06-Q1-SAFETTA-PUBLIC-PAPER-STAT-REPLAY-v2"
...
STAGES: Tuple[ReplayStage, ...] = (
    ...
    ReplayStage(
        ...
        ("point", "summary", "bootstrap", "utility", "random"),
        "2ff2e110a0ee62c4f7d142c4deba202259fc25e0be69f096c5d599f59403aba4",
    ),
)
...
def main() -> int:
    ...
    root = args.root
    default_replay_root = (
        root / "outputs" / "Q1_SAFETTA_public_paper_stat_replay_v2"
    )
    ...
    print("===== SAFETTA PUBLIC PAPER-STATISTIC REPLAY V2 =====")
    ...
    report = {
        ...
        "public_level_a_mode": (
            "R10L0, R15A1, R15B1 and CM7B execute retained historical analysis "
            "scripts. PolypGen R10L3C, SUN R14C3B and PROMISE CM6 paper-facing "
            "statistics are freshly recomputed from their frozen post-GT row-level "
            "evaluation panels/outcomes to avoid redistributing raw GT and large "
            "prediction arrays."
        ),
    ...
    print("\n" + "\n".join(lines))
    return 0 if gate == "PASS_NUMERIC_REPLAY" else 3
