...
VERSION = "2026-09-04-Q1X-CM3-v1-fix1"
BUILD = "Q1X_CM3_SOURCE_OOF_SEGMENTATION_TRAINING_AND_PREDICTION_LOCK_FIX1"
...
def build_model(family: str):
    ...
    if family == "SegFormer_B0":
        try:
            ...
            raise RuntimeError(
                "transformers is required for SegFormer-B0."
            ) from e

        core = SegformerForSemanticSegmentation.from_pretrained(
            "nvidia/mit-b0",
            num_labels=1,
...
def main():
    ...
    print("===== Q1X CM3 SOURCE OOF SEGMENTATION TRAINING =====")
