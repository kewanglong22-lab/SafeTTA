...
VERSION = "2026-09-04-Q1X-CM3-v1-fix2"
BUILD = "Q1X_CM3_SOURCE_OOF_SEGMENTATION_TRAINING_AND_PREDICTION_LOCK_FIX2"
...
def build_model(family: str):
    ...
    if family == "SegFormer_B0":
        ...
        state = safe_load_file(str(safe_weight_path), device="cpu")
        ...
        if bad_missing or bad_unexpected:
            raise RuntimeError(
                "Unexpected SegFormer encoder load incompatibility: "
...
def main():
    ...
    print("===== Q1X CM3 FIX2 SOURCE OOF SEGMENTATION TRAINING =====")
    print("FIX2_CHANGE=SEGFORMER_IMAGENET_ENCODER_SAFE_TENSOR_LOCK")
